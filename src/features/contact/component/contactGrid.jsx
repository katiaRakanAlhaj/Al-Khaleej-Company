...
const ContactGrid = () => {
  return (
    <div className="grid grid-cols-2 gap-x-[4rem] mt-[6rem]">
      {/* first column */}
      <div>
        <h1 className="text-[#252525] font-bold text-5xl">
          Have questions? connect with us for support
        </h1>
        <p className="text-[#252525] text-xl mt-4">
          Connect with our experts and experience seamless assistance every step
          of the way,
        </p>
        {/* Google Maps Iframe */}

        <div className="w-full h-[38rem] border border-[#F9F9FF33] mt-[1rem] rounded-lg overflow-hidden shadow-lg">
          <iframe
